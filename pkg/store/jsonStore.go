...
type Store interface {
	...
	PrecioConsumidor(ids []int) (domain.ConsumerPriceResponse, error)
}
...
func (s *jsonStore) PrecioConsumidor(ids []int) (domain.ConsumerPriceResponse, error) {

	products, err := s.loadProducts()
	if err != nil {
		return domain.ConsumerPriceResponse{}, err
	}
	...
	productsResponse := domain.ConsumerPriceResponse{
		Products:   p,
		TotalPrice: total,
	}
